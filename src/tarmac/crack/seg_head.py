...
from tarmac.datasets.find_crack import find_find_crack_pairs
from tarmac.datasets.hf_crack import find_hf_crack_pairs
from tarmac.datasets.masonry_crack import find_masonry_crack_pairs
from tarmac.datasets.metu_crack_seg import find_metu_crack_seg_pairs
from tarmac.datasets.paggnet_crack import find_paggnet_crack_pairs
...
def _fallback_records(seed: int = SEED) -> list[SegRecord]:
    ...
    records.extend(("find_crack", image, mask) for image, mask in find_find_crack_pairs(Path("data/raw/find_crack")))
    records.extend(("masonry_crack", image, mask) for image, mask in find_masonry_crack_pairs(Path("data/raw/masonry_crack")))
    records.extend(("hf_crack", image, mask) for image, mask in find_hf_crack_pairs(Path("data/raw/hf_crack")))
    records.extend(("paggnet_crack", image, mask) for image, mask in find_paggnet_crack_pairs(Path("data/raw/paggnet_crack")))
